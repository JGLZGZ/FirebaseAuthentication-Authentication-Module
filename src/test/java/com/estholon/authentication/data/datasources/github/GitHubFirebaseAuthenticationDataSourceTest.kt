...
class GitHubFirebaseAuthenticationDataSourceTest {

    private lateinit var firebaseAuth: FirebaseAuth
    private lateinit var dataSource: GitHubFirebaseAuthenticationDataSource
    ...
    @Test
    fun `signInGitHub returns user on pending result success`() = runTest {
        // Given
        ...
        // When
        val result = dataSource.signInGitHub(activity)
    ...
    @Test
    fun `linkGitHub returns success`() = runTest {
        // Given
        val activity = mockk<Activity>()
        val firebaseUser = mockk<FirebaseUser>()
        ...
        // When
        val result = dataSource.linkGitHub(activity)
